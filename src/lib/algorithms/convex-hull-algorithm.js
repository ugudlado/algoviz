...
var ConvexHullAlgorithm = (() => {
  ...
  function grahamScan(inputPoints) {
    ...
    steps.push({
      ...
      explanation:
        "Push first sorted point " + indices[0] + " onto hull stack.",
      pointsProcessed: 2,
      hullSize: 2,
    });
    ...
    steps.push({
      ...
      discarded: discarded.slice(),
      explanation:
        "Push second sorted point " + indices[1] + " onto hull stack.",
      pointsProcessed: 3,
      hullSize: 3,
    });
    ...
    for (i = 2; i < indices.length; i++) {
      ...
      steps.push({
        ...
        currentPoint: ptIdx,
        discarded: discarded.slice(),
        explanation: "Left turn confirmed — point " + ptIdx + " added to hull.",
        pointsProcessed: pointsProcessed,
        hullSize: stack.length,
      });
    }
