        ...
        <div className="main-column">
          <ProblemFrame title="The Problem">
            ...
            <div className="app-section">
              ...
              <p>
                Sort it in O(n log n) by recursively splitting the array in
                half, sorting each half, then merging the sorted halves back
                together.
              </p>
            </div>
            <div className="app-section">
              ...
              <p>
                External sorting (files too large for RAM), stable sort in
                standard libraries, inversion counting.
              </p>
            </div>
          </ProblemFrame>
